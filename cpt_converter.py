...
parser.add_argument('loadpaths', help='The full file path to the data to '\
                    'be converted.')
parser.add_argument('savepath', help='The full file path to where the '\
...
savepath = cpt_converter(args.loadpaths, args.savepath, args.variable, args.simple)
